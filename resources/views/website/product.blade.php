            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="product-details">
                        ...
                        <div>
                            <h3 class="product-price">$980.00 <del class="product-old-price">{{ $product->peice }}</del>
                            </h3>
                        ...
                        {{-- <ul class="product-btns">
							...
							<li><a href="{{ route('website.buy') }}"><i class="fa fa-heart-o"></i> add to wishlist</a></li>
